...
export default function PackageCard({ p }) {
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 duration-300 transition-all duration-300 group">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-4 mt-5">
          <IncludeIcon active={p.includes?.flights} icon={Plane} />
          <IncludeIcon active={p.includes?.hotel} icon={Hotel} />
          <IncludeIcon active={p.includes?.meals} icon={Utensils} />
          <IncludeIcon active={p.includes?.transfers} icon={Car} />
        </div>
